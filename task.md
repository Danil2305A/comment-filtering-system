...
Язык: Java (JDK 21 как минимум)

Система сборки: Gradle

Модульные тесты с использованием JUnit 5

Использование любых подходящих паттернов проектирования

Чистый код, принципы SOLID и бла-бла-бла)
